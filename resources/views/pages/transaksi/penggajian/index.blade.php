...
<div class="row">
    <div class="col-md-12">
        <div class="box box-danger">
            ...
            <div class="box-body">
                <a href="{{ route('transaksi.penggajian.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>
                    Penggajian</a>
                <div class="row mt-3">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            @include('pages.transaksi.penggajian.table')
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function(){
        ...
        function loadTable(bulan,tahun,lanjut="all"){
            let url = `{{ url('transaksi/penggajian/loadTable?bulan=${bulan}&tahun=${tahun}&lanjut=${lanjut}') }}`;
