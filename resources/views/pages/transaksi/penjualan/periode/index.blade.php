                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            @include('pages.transaksi.penjualan.periode.table')
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function(){
        ...
        function loadTable(transaksi="all",tanggal_awal,tanggal_akhir,lanjut="all"){
            let url = `{{ url('transaksi/penjualan/periode/loadTable?transaksi=${transaksi}&start=${tanggal_awal}&end=${tanggal_akhir}&lanjut=${lanjut}') }}`;
