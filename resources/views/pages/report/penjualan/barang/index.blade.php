...
<script>
    $(document).ready(function(){
        ...
        $('.print').click(function(){
            ...
            let url = `{{ url('report/penjualan/barang/print?barang=${barang}&start=${tanggal_awal}&end=${tanggal_akhir}') }}`;
        ...
        function loadTable(barang="all",tanggal_awal,tanggal_akhir){
            let url = `{{ url('report/penjualan/barang/loadTable?barang=${barang}&start=${tanggal_awal}&end=${tanggal_akhir}') }}`;
            const parseResult = new DOMParser().parseFromString(url, "text/html");
            const parsedUrl = parseResult.documentElement.textContent;
