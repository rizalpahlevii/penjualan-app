...
@section('page','Edit Jabatan Pegawai')
@section('content')
<div class="row">
    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group @error('nama') has-error @enderror">
                                ...
                                <input type="text" class="form-control" name="nama" id="nama"
                                    placeholder="Nama Jabatan...." value="{{$jabatan->nama }}">
                                @error('nama')
                        ...
                        <div class="col-md-6">
                            <div class="form-group @error('gaji_pokok') has-error @enderror">
                                ...
                                <input type="number" class="form-control" name="gaji_pokok" id="gaji_pokok"
                                    placeholder="Gaji Pokok...." value="{{ $jabatan->gaji_pokok }}">
                                @error('gaji_pokok')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @error('lain_lain') has-error @enderror">
                                ...
                                <input type="number" class="form-control" name="lain_lain" id="lain_lain"
                                    placeholder="Lain Lain...." value="{{ $jabatan->lain_lain }}">
                                @error('lain_lain')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @error('deskripsi') has-error @enderror">
                                ...
                                <textarea name="deskripsi" id="deskripsi" cols="30" rows="10" class="form-control"
                                    placeholder="Deskripsi Pekerjaan">{{ $jabatan->deskripsi }}</textarea>
                                @error('deskripsi')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
